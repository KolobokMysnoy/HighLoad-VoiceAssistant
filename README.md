...
| Kafka | Audios(AudioStore) | Хранит временные данные для записи раз в 5 минут в Hadoop. Получает от сервера записи голоса полностью вместе с расшифровкой[^31] | Высокая производительность. . Горизонтальное маштабирование: создание нескольких брокеров | Создание BackUP на случай падения. Также создание Kafka-broker с помощью Zookeeper, чтобы выдерживать нагрузку | Раз в 5 минут | 3 819 | 252ГБ |
