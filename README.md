...
6. [Физическая схема баз данных](#bd-phys) <br>
7. [Софт](#soft) <br>
8 [Технологии](#tech) <br>
8.1 [Сервисы](#service)<br>
9. [Надежность](#reliability)<br>
10. [Рассчет оборудования](#count)<br>
...
# 6. Физическая схема баз данных <a name="bd-phys"></a>
...
# 7. Софт <a name="soft"></a>

## 7.1 Latency-based DNS

<!-- TODO расписать путь голоса до финала -->
<!-- TODO как точно распределяется при падении одного ДЦ -->
...
<!-- TODO сервис распознавания интента, описать как работает ML -->

# 9 Надежность <a name="reliability"></a>
...
# 10 Рассчет оборудования <a name="count"></a>
