...
Для распределения трафика между дата центрами будет использоваться система  клиентской балансировки, так как в России есть особенности у мобильных провайдеров с их DNS. 
